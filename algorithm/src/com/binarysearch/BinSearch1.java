...
/**
 * A binary search or half-interval search algorithm finds the 
 * position of a specified value (the input "key") within a sorted array. 
 * In each step, the algorithm compares the input key value with the key 
 * value of the middle element of the array. If the keys match, then a matching element 
 ...
 * the middle element or, if the input key is greater, on the sub-array to the right. 
...
public class BinSearch1 {
	...
	public static void main(String[] args) {
		...
		BinSearch1 search = new BinSearch1();
		int[] arr = { 2, 4, 6, 8, 10, 12, 14, 16 };
		System.out.println("Key 14's position: " + search.binarySearch(arr, 14));
		int[] arr1 = { 6, 34, 78, 123, 432, 900 };
		System.out.println("Key 432's position: " + search.binarySearch(arr1, 432));
	}
}
